 ...
 * @param {Function} backAction - A função de retorno (Voltar).
 * @param {string|null} horario - Horário a ser exibido (opcional).
 */
export function createPageHeader(title, backAction, horario = null) {
    ...
    // -----------------------------------------------------------
    // 2. CONTAINER DO TÍTULO E HORÁRIO (Centralizado)
    // -----------------------------------------------------------
    ...
    // Adiciona o horário se ele for fornecido
    if (horario) {
        const timeEl = document.createElement('div');
        timeEl.innerHTML = `<i class="fas fa-clock" style="margin-right: 5px;"></i> ${horario}`;
        ...
        `;
        titleContainer.appendChild(timeEl);
    }
