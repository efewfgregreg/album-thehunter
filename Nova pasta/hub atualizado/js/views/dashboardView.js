...
export function renderDashboardView(container, savedData, navigateCallback) {
    ...
    style.textContent = `
        ...
        .content-area { flex: 1; padding: 40px 50px; overflow-y: auto; position: relative; display: grid; grid-template-columns: 1fr 320px; gap: 30px; background-size: cover; background-position: center; }
        .content-overlay { position: fixed; top: 0; left: var(--sidebar-w); right: 0; bottom: 0; background: rgba(0, 0, 0, 0.85); pointer-events: none; z-index: 0; }
