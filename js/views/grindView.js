...
export async function renderGrindCounterView(sessionId) {
    ...
    // =================================================================
    // ★ CORREÇÃO DEFINITIVA: ATUALIZA "ATIVO" AO ENTRAR
    // Atualiza o carimbo de tempo imediatamente ao abrir a tela.
    // Isso força o Dashboard a reconhecer este grind como o atual.
    // =================================================================
