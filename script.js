...
// LISTAS CORRIGIDAS E COMPLETAS
const maleAndFemaleDiamondSpecies = ["lebre_peluda", "raposa_cinzenta", "lebre_da_eurasia", "coelho_da_florida", "oryx_do_cabo", "castor_norte_americano", "codorniz_da_virgínia", "cão_guaxinim", "jacaré_americano"];
const femaleOnlyDiamondSpecies = ["lebre_nuca_dourada", "lebre_europeia"];
...
const diamondFursData = {
    ...
    "lebre_da_eurásia": { macho: ["Branco"], femea: ["Branco"] },
    ...
    "porco_selvagem": { macho: ["manchas pretas variação 1", "manchas pretas variação 2", "hibrido marrom variação 1", "hibrido marrom variação 2", "marrom escuro variação 1", "marrom escuro variação 2", "Preto", "Preto e Dourado"], femea: [] },
