...
<head>
    ...
    <style>
        ...
        * { 
        ...
        /* --- GRIDES DE CARDS (ANIMAIS, RESERVAS, PELAGENS) --- */
        ...
        .fur-card { border-radius: 8px; padding: 10px; text-align: center; transition: all 0.3s ease; border: 2px solid transparent; display: flex; flex-direction: column; justify-content: space-between; gap: 10px; position: relative; }
        ...
        /* --- ESTILOS PARA DIAMANTES (Versão 2) --- */
        .fur-card { background: linear-gradient(145deg, #2c2f33, #232529); box-shadow: 0 4px 15px rgba(0,0,0,0.2), inset 0 1px 2px rgba(255,255,255,0.05); }
        ...
        .fur-card.completed { border-color: var(--gold-color); box-shadow: 0 0 15px rgba(255, 215, 0, 0.3), 0 4px 15px rgba(0,0,0,0.2), inset 0 1px 2px rgba(255,215,0,0.1); }
        .fur-card.completed .info { color: var(--text-color); }
        ...
        .trophy-manager-modal { position: fixed; z-index: 2000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.7); display: flex; align-items: center; justify-content: center; backdrop-filter: blur(5px); }
        ...
        /* --- ESTILOS ABA RESERVAS (PAINEL DE CONTROLE) --- */
        ...
        .reserve-detail-view .animal-checklist { display: flex; flex-direction: column; gap: 10px; }
