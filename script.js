// ==================================================================
// == SCRIPT.JS FINAL E COMPLETO - ÁLBUM DE CAÇA THE HUNTER
// ==================================================================
...
function checkAndSetSuperRaroCompletion(slug, currentData) {
    const fursInfo = rareFursData[slug];
    if (!fursInfo || !currentData) { currentData.completo = false; return; }
    const allFurs = [...new Set([...(fursInfo.macho || []), ...(fursInfo.femea || [])])];
    currentData.completo = allFurs.every(furName => currentData.combinations?.[furName]?.completed === true);
}
