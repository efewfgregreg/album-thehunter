...
let mainContent; // Será definido no DOMContentLoaded
...
function createAnimalCard(name, tabKey) {
    ...
    // updateCardAppearance(card, slug, tabKey); // A aparência será atualizada dinamicamente
    return card;
}
...
// Funções de Update de Aparência e Painel de Progresso (precisarão de revisão futura)
