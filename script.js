...
// CORREÇÃO 1: Botão Voltar
function showDetailView(name, tabKey) {
    appContainer.innerHTML = '';
    const slug = slugify(name);

    // Cria os containers principais primeiro
    const mainContent = document.createElement('div');
    mainContent.className = 'main-content';
    ...
    // Preenche o conteúdo de detalhes
    if (tabKey === 'greats') {
    ...
    // Adiciona tudo à página de uma só vez no final
    appContainer.appendChild(mainContent);
}
...
// CORREÇÃO 2: Cálculo de Super Raros
