...
const diamondFursData = {
    ...
    "chacal_listrado": { macho: ["Pardo", "Cinzento", "Pardo Claro", "Pardo Cinza"], femea: [] },
    ...
    "ibex_espanhol_do_sudeste": { macho: ["Pardo", "pardo hibrido", "pardo acinzentado", "cinza claro", "laranja"], femea: [] },
    ...
    "porco_selvagem": { macho: ["Manchas Pretas", "Marrom Híbrido", "Preto", "Preto e Dourado", "pardo claro variação 1", "pardo claro variação 2"], femea: [] },
    ...
    "zarro_negrinha": { macho: ["Preto", "Pardo"], femea: [] },
