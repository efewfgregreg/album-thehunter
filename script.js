...
function loadData() {
    ...
    } catch (e) { console.error("Erro ao carregar dados do localStorage", e); return {}; }
}
function saveData(data) {
    ...
    } catch (e) { console.error("Erro ao salvar dados no localStorage", e); }
}
...
function updateCardAppearance(card, slug, tabKey) {
    ...
    // Adicionar lógicas para outras abas aqui no futuro
